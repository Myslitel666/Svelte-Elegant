...
<Header>
	<button style:gap="0.5rem">
		...
		<p style:font-size="26px">
			<span style:color={svelteColor} style:filter={logotypeFilter} style:transition="all 0.3s">
				Svelte
			</span>
			<span style:color={elegantColor} style:transition="all 0.3s"> Elegant </span>
		</p>
	</button>
